...
void plotterSystJES(int year = 2018, int whichSample = 1){
	...
	if (whichSample==0) sprintf(filename,"template/root_output_files/qqzz_Moriond_JES_%d.root",year); 
	if (whichSample==1) sprintf(filename,"template/root_output_files/ggzz_Moriond_JES_%d.root",year); 
	if (whichSample==2) sprintf(filename,"template/root_output_files/vbs_Moriond_JES_%d.root",year);
	if (whichSample==4) sprintf(filename,"template/root_output_files/ttzwzz_Moriond_JES_%d.root",year);
	...
	// c1->cd();
	if (whichSample == 0) sprintf(filename,"syst/%s_qqZZ_SystJES_%d.png",namegif.c_str(),year);      
	if (whichSample == 1) sprintf(filename,"syst/%s_ggZZ_SystJES_%d.png",namegif.c_str(),year);
	if (whichSample == 2) sprintf(filename,"syst/%s_VBS_SystJES_%d.png",namegif.c_str(),year);
	if (whichSample == 4) sprintf(filename,"syst/%s_ttZWZZ_SystJES_%d.png",namegif.c_str(),year);
	c1->Print(filename);
